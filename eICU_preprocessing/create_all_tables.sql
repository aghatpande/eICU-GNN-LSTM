...
-- this script worked on 4/27/2023 using :
...
-- then run this script as: \i eICU_preprocessing/create_all_tables.sql

\i /Users/asgnxt/hcnet/eICU-GNN-LSTM/eICU_preprocessing/labels.sql
\i /Users/asgnxt/hcnet/eICU-GNN-LSTM/eICU_preprocessing/diagnoses.sql
\i /Users/asgnxt/hcnet/eICU-GNN-LSTM/eICU_preprocessing/flat_features.sql
...
\copy (select * from diagnoses as d where d.patientunitstayid in (select * from timeseries_patients)) to '/Users/asgnxt/hcnet/eICU-GNN-LSTM/eICU_data/diagnoses.csv' with csv header
\copy (select * from flat as f where f.patientunitstayid in (select * from timeseries_patients)) to '/Users/asgnxt/hcnet/eICU-GNN-LSTM/eICU_data/flat_features.csv' with csv header
