# this works for the eICUdemo dataset but does not use the timeseries data and does not split into train/test/val
# from eICU_preprocessing.timeseries import timeseries_main
from eICU_preprocessing.diagnoses_alt import diagnoses_main
from eICU_preprocessing.flat_and_labels_alt import flat_and_labels_main
