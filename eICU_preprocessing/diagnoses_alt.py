...
def add_adm_diag(sparse_df, eICU_path, cut_off):
    ...
    print('==> Adding admission diagnoses from flat_features_alt.csv...')
    flat = pd.read_csv(eICU_path + 'flat_features_alt.csv')
...
def diagnoses_main(eICU_path, cut_off_prevalence):
    ...
    print('==> Loading data diagnosesalt.csv...')
    diagnoses = pd.read_csv(eICU_path + 'diagnosesalt.csv')
    ...
    sparse_df.to_csv(eICU_path + 'preprocessed_diagnoses_alt.csv')
